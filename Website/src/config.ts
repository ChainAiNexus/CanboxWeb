...
// api
export let baseUrl: string = 'https://dapp.chainainexus.com/api';
// export let baseUrl: string = 'http://192.168.1.37:28899';
...
export const TOKEN_PROGRAM_ID = 'BBCvV3NHBKhoVz828ie4KwZ1PYHk5yRXH9A4ukppSALn'; // 
