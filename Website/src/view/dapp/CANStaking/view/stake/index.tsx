...
import { getPledgeRecord, getTokenContractAddress } from '../../../../../API';
...
function App() {
  ...
  const Anchorwallet = useAnchorWallet(); // nft wallet
  const handleStake = async () => {
    ...
    geMint(publicKey, () => {
      ...
      showLoding(false)
      setAmount('')
    }, connection, Anchorwallet, amount, 'Hr67R4CzkyuyeYLVEd7xZ4Ng2mj6vpaw2et1EHMAHZfB', () => {
      // 
      showLoding(false)
    });
  }
  ...
  return (
    <div className="main_app">
      ...
      <div className=" w-[400px] mx-auto pt-[130px]">
        <div className=" px-20">
          ...
          >
            ...
            <div className="flex items-center justify-center flex-1 ">
              ...
              <div className="text-[#fff] text-[16px] flex-1 text-right pr-[20px]">{balance_SOLX}</div>
            </div>
        ...
        <div
          onClick={() => {
            navigate('/dapp/CANStaking/stake/details');
          ...
          <div className="text-[#3DFFFF] text-[16px] ml-8">{PledgeRecord?.total || 0}</div>
          <div
