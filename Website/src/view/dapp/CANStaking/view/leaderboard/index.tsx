...
import nodata from '../../../../../assets/image/new/dapp/nodata.png';
            ...
            <div className=" w-[400px] mx-auto pt-[130px]">
                ...
                <div className="mx-20 pt-20 hidden">
                    {[1, 2, 3, 4, 5, 6].map((item) => (
                        <div className="p-[10px] mb-10 rounded-[10px] flex items-center bg-[rgb(5,57,66)] " key={item}>
                            <img src={icon1} className="w-[50px] h-[50px] rounded-full mr-10" alt="" />
                ...
                <div className="mx-20 pt-[40px]">
                    <img src={nodata} className="w-[160px] h-[160px] mx-auto inline-block]" alt="" />
                </div>
                <TabIndex index={3} />
            </div>
        </div>
