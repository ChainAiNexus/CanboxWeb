...
function App(props: TabProps) {
  ...
  return (
    <div className="fixed bottom-0  left-auto w-[375px] p-10">
      <div className="bg-[#152722] flex justify-center items-center rounded-[10px] py-6">
        ...
        >
          ...
          <div
            className="text-[14px]"
            style={{ color: props.index === 1 ? "#fff" : "#818181" }}
          >
            Home
          </div>
        </div>
        ...
        >
          ...
          <div
            className="text-[14px] "
            style={{ color: props.index === 2 ? "#fff" : "#818181" }}
          >
            Stake
          </div>
        </div>
        ...
        >
          {props.index === 3 ? (
            <img
              src={icon5}
              className="inline-block mx-auto w-[10px] h-[20px]"
              alt=""
            />
          ) : (
            <svg
